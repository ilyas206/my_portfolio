export const educationData = [
  {
    ...
    highlights: [
        ...
        'Mathematics — algebra, calculus, logic foundations',
        'Bilingual instruction (Arabic & French)',
        'Analytical reasoning & scientific methodology',
    ],
  },
  {
    ...
    highlights: [
        'Frontend & backend development (React JS & Laravel)',
        'Database design (UML) & management',
        'Cloud-native application architecture',
        'Agile methodology (SCRUM) & real-world project',
    ],
  },
  {
    degree: "Professional Bachelor's Degree (Licence)",
    ...
    highlights: [
        'OOP, Python & C++ with security orientation',
        'Advanced databases & Oracle administration',
        'Networking, Unix & Windows Server administration',
        'Web development — PHP, JSP/Servlet, React (MVC)',
    ],
  },
]